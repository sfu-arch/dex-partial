#!/bin/bash
# DEX Range + Lookup Latency Benchmark - Node 1+ (Worker/Memory Node)
...
echo "=========================================="
echo "DEX Range+Lookup Benchmark - Worker Node"
...
# ============================================
echo ""
echo ">>> Running DEX range+lookup benchmark (Worker Node)..."
